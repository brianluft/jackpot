    ...
    public ConvertMoviesForm(Preferences preferences)
    {
        ...
        Controls.Add(_table = ui.NewTable(2, 6));
        {
            ...
            _table.Controls.Add(_topFlow1 = ui.NewFlowRow(), 0, 2);
            {
                ...
                _qualityCombo = _topFlow1.AddPair(ui.NewLabeledPair("Video quality:", ui.NewDropDown(200)));
                {
                ...
                _speedCombo = _topFlow1.AddPair(ui.NewLabeledPair("Compression level:", ui.NewDropDown(200)));
                {
                    List<string> speeds =
                    [
            ...
            _table.Controls.Add(_topFlow2 = ui.NewFlowRow(), 0, 3);
            {
                ...
                _audioCombo = _topFlow2.AddPair(ui.NewLabeledPair("Audio bitrate:", ui.NewDropDown(200)));
                {
                    List<string> speeds =
                    [
